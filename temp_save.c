...
bit settings_page_active = 0, up_key_latched = 0, down_key_latched = 0, set_key_latched = 0,home_key_latched=0;
...
#define CUR_ADC_OFFSET 2.47 // 2.10 , 2.47 , 2.5
...
bit is_home_key_pressed()
{
    if (BTN_HOME == 1 && home_key_latched == 0)
    {
        Timer2_Delay(24000000, 1, 100);
        home_key_latched = 1;
        menu_timeout_counter = 0;
        ...
        if (display_refresh_pending && startup_delay_active == 0)
        {
            ...
            else
            {
                ...
                case US_PASSWORD:
                    ...
                    if (is_home_key_pressed() && edit_value == 5)
                    {
                ...
                case FS_PASSWORD:
                    tm1637_display_number((unsigned int)edit_value);
                    if (is_home_key_pressed() && edit_value == 998)
                    {
