...
//--gama------
  ...
  for (;;) {
   ...
   if(GPIO_readPin(227) == 0) {
    ...
    case IP_LOW:
      lcd_printf("IP LOW: ");
      lcd_printf("%4d", store_data.ip_low_voltage);
      lcd_setCursor(0, 1);
      lcd_printf("<-- EDIT:P07 -->");
      if (GPIO_readPin(UP) == 0) {
      ...
      if (GPIO_readPin(SET) == 0) {
        edit_screen = 1;
        pre_state = display_state;
        set_number(store_data.ip_low_voltage);
        display_state = EDIT;
      }
      break;
    ...
    case IP_HIGH:
      lcd_printf("IP HIGH: ");
      lcd_printf("%4d", store_data.ip_high_voltage);
      lcd_setCursor(0, 1);
      lcd_printf("<-- EDIT:P07 -->");
      if (GPIO_readPin(UP) == 0) {
    ...
    case OP_LOW:
      lcd_printf("OP LOW: ");
      lcd_printf("%4d", store_data.op_low_voltage);
      lcd_setCursor(0, 1);
      lcd_printf("<-- EDIT:P07 -->");
      if (GPIO_readPin(UP) == 0) {
      ...
      if (GPIO_readPin(SET) == 0) {
        edit_screen = 1;
        pre_state = display_state;
        set_number(store_data.op_low_voltage);
        display_state = EDIT;
      }
      break;
    ...
    case OP_HIGH:
      lcd_printf("OP HIGH: ");
      lcd_printf("%4d", store_data.op_high_voltage);
      lcd_setCursor(0, 1);
      lcd_printf("<-- EDIT:P07 -->");
      if (GPIO_readPin(UP) == 0) {
        display_state = HI_LO_TIME;
